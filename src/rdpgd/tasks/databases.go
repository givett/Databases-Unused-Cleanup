...
func (t *Task) postgresqlPrecreateDatabase(client *consulapi.Client) (err error) {
	...
	err = p.CreateExtensions(i.Database, []string{`btree_gist`, `pg_stat_statements`, `uuid-ossp`, `hstore`, `pg_trgm`})
	if err != nil {
...
func (t *Task) bdrPrecreateDatabase(client *consulapi.Client) (err error) {
	...
	*/
	...
	err = b.CreateExtensions(i.Database, []string{`btree_gist`, `bdr`, `pg_stat_statements`, `uuid-ossp`, `hstore`, `pg_trgm`})
	if err != nil {
